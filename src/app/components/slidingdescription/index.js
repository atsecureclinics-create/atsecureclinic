  ...
  return (
    ...
    >
      <div className="container px-4 sm:px-6 md:px-8 mx-auto max-w-4xl">
        <h2 className="mb-4 text-3xl 2xl:text-4xl font-bold text-center leading-normal text-navy" >
          ...
          {slides.map((item, i) => (
            <SwiperSlide key={i}>
              <blockquote className="relative mt-10 pl-8 text-center ">
                <p className="text-navy text-lg md:text-xl lg:text-4xl leading-relaxed text-center inline-block relative">
                  <div
