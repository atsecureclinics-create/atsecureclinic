          ...
          {slides.map((item, i) => (
            <SwiperSlide key={i}>
              <blockquote className="relative mt-10 pl-8 text-center ">
                <p className="font-opensans text-lg md:text-2xl lg:text-3xl leading-relaxed text-center inline-block relative text-white font-bold">
                  <div
                    className="text-[120px] md:text-[160px] lg:text-[150px] font-serif leading-none select-none pointer-events-none -mb-16 md:-mb-20 lg:-mb-24 absolute -top-12 -left-12 z-10"
                    // style={{ color: "rgba(255, 255, 255, 0.15)" }}
                    aria-hidden
                  >
                    <div className=" w-16 " aria-hidden="true">
                      <svg width="60" height="96" viewBox="0 0 116 96" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
