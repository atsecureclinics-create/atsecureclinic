            ...
            <SwiperSlide key={i}>
              <blockquote className="relative mt-2 md:mt-4 px-4 text-center">
                <span
                  ...
                  aria-hidden="true"
                >
                  <svg width="40" height="64" viewBox="0 0 116 96" className="md:w-15 md:h-24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className="relative font-opensans text-base sm:text-lg md:text-2xl lg:text-3xl leading-relaxed text-white font-bold">
                  {item.quote}
                </p>
              </blockquote>
            </SwiperSlide>
