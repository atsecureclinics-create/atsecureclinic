    ...
    return (
      <section className="bg-vanilla py-20">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          {/* CONTENT */}
          <div className="lg:col-span-6">
            <p className="text-sm font-semibold tracking-[0.25em] text-coral uppercase mb-6">
              Contact
            </p>
            ...
            <p className="text-lg text-navy/80 max-w-xl mb-12">
            ...
            {/* CTA */}
            <button className="inline-flex items-center justify-center rounded-full bg-green px-10 py-4 text-white font-semibold tracking-wide hover:opacity-90 transition">
              Book a consult
            </button>
          </div>
