...
const steps = [
    {
        ...
        text: "Every journey starts with listening. Your orthopaedic concerns, pain history, activity goals and lifestyle are fully understood before any treatment is suggested.",
    },
    {
        number: "02",
        title: "Advanced Diagnostic Assessment",
        text: "A thorough clinical evaluation combined with imaging and diagnostic tools identifies the exact cause and extent of your orthopaedic condition.",
    },
    {
        number: "03",
        title: "Nothing Is Rushed",
        text: "Surgery is never the first step. All conservative options are explored first — ensuring every decision is thoughtful, evidence-based and patient-focused.",
    },
    {
        number: "04",
        title: "A Plan Made Just for You",
        text: "No standard protocols. No packages. Each treatment plan — from approach to technique to recovery — is tailor-made for your specific orthopaedic condition.",
    },
    {
        number: "05",
        title: "Precision Over Trauma",
        text: "We focus on treating the problem with minimal disruption to healthy tissue. Minimally invasive techniques reduce surgical trauma and enable faster recovery.",
    },
    {
        number: "06",
    ...
    },
    {
        ...
        text: "We guide you through physiotherapy, strength training, aqua therapy and rehabilitation. Every step is designed for safe and effective orthopaedic recovery.",
    },
    {
        number: "08",
...
export const metadata = {
    title: "Orthopaedic Conditions Treatment in Mumbai | Secure Clinics",
    description: "Expert care for all orthopaedic conditions in Mumbai — frozen shoulder, ACL tear, knee arthritis, hip fracture and more. Specialist-led orthopaedic care.",
};

function OrthopaedicConditions() {
    return (
        <div>
            {/* HERO */}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                        <div className="lg:col-span-7 xl:col-span-6">
                            ...
                            <h1 className="text-2xl sm:text-4xl md:text-5xl xl:text-6xl font-semibold leading-tight text-navy mb-4 md:mb-5">
                                Orthopaedic Care, Considered Carefully.
                            </h1>

                            <p className="font-opensans text-sm md:text-xl lg:text-2xl leading-relaxed">
                                Expert diagnosis and treatment for all orthopaedic conditions — from frozen shoulder and ACL tears to knee arthritis and hip conditions. Precision-led, patient-first care.
                            </p>
                        </div>
            ...
            <section className="py-4 md:py-18 bg-vanilla">
                <Container>
                    <div className="font-opensans text-sm md:text-lg lg:text-xl text-navy leading-relaxed space-y-5 md:space-y-6">
                        <p>
                            At Secure Clinics, orthopaedic care begins with the right diagnosis — not a rushed recommendation. Every patient presenting with an orthopaedic condition is evaluated through detailed clinical assessment, advanced imaging and multidisciplinary discussion before any treatment is suggested.
                        </p>
                        <p>
                            Whether you are dealing with a frozen shoulder, rotator cuff tear, osteoarthritis of the knee, ACL tear, meniscus tear, tennis elbow, carpal tunnel syndrome, ankle sprain, hip fracture, avascular necrosis, flat feet, hip impingement or any other orthopaedic condition — our specialists are experienced in treating the full spectrum of musculoskeletal problems.
                        </p>
                        <p>
