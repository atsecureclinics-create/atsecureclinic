            ...
            <section className="py-14 md:py-18 bg-vanilla">
                <Container>
                    <div className="font-opensans text-base md:text-lg lg:text-xl text-navy leading-relaxed space-y-5 md:space-y-6">
                        ...
                        <p>
                            Our non-surgical programmes combine physiotherapy, strength training, aqua therapy, clinical nutrition, image-guided injections and advanced diagnostics — delivered by specialists who work as one coordinated team.
                        </p>
                        <p>
