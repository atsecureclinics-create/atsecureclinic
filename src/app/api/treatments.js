...
export const treatments = [
  // ───────────────────────── PAGE 1 ─────────────────────────
  {
    ...
    category: "surgical",
    cardTitle: "ENDOSCOPIC SURGERY",
    iconKey: "activity",
    metaTitle: "Endoscopic Spine Surgery in Mumbai | SecureClinics",
    metaDescription:
      "Pioneering endoscopic spine surgery in Mumbai. Smaller incisions, faster recovery and surgical precision backed by a decade of experience.",

    hero: {
      eyebrow: "SPINE@SECURECLINICS",
      title: "Endoscopic Spine Surgery in Mumbai",
      tagline: "Minimally Invasive Spine Treatment for Faster Recovery <code>&amp;</code> Reduced Pain",
      intro: [
        ...
        "At Secure Clinics, Mumbai, our spine specialists use precision-based surgical approaches to treat conditions affecting the discs, nerves, and spinal canal while focusing on preserving normal spinal structures and supporting faster rehabilitation.",
    ...
    procedures: {
      eyebrow: "Procedures",
      heading: "Endoscopic Spine Procedures We Offer",
      items: [
        { number: "01", title: "Endoscopic Discectomy", description: "Minimally invasive removal of slipped or herniated disc material causing nerve compression and leg or arm pain." },
        { number: "02", title: "Endoscopic Decompression", description: "Precise relief of spinal canal or nerve root compression in conditions like spinal stenosis, using muscle-sparing techniques." },
        { number: "03", title: "Endoscopic Fusion", description: "Selective cases where spinal stability is restored using endoscopic assistance — minimising tissue damage while achieving long-term stability." },
        { number: "04", title: "Cervical Endoscopic Spine Surgery", description: "Advanced endoscopic procedures for neck pain, cervical disc prolapse and nerve compression with minimal incision and faster recovery." },
        { number: "05", title: "Thoracic Endoscopic Spine Surgery", description: "Highly specialised endoscopic treatment for thoracic spine conditions — performed by experienced hands only when truly indicated." },
        { number: "06", title: "Endoscopic Surgery for Spine Infections", description: "Targeted endoscopic intervention in select spinal infections for decompression, biopsy or drainage — reducing surgical trauma in fragile patients." },
      ],
    },

    benefits: {
      eyebrow: "Benefits",
      heading: "Benefits of Endoscopic Spine Surgery ",
      items: [
        "Minimally invasive spine surgery",
        "Smaller incisions (often under 1 cm)",
        "Minimal blood loss",
        "Reduced muscle damage",
        "Early mobilisation — often within hours",
    ...
    rightForYou: {
      eyebrow: "Eligibility",
      heading: "Is Endoscopic Spine Surgery Right for You?",
      intro: "Endoscopic spine surgery may be suitable if you have:",
      items: [
        "Slipped disc (lumbar or cervical)",
        "Sciatica or nerve pain",
        "Spinal stenosis",
        "Certain spine infections",
        "Persistent pain despite conservative care",
      ],
      closing:
        "A detailed consultation is essential to decide the right path.",
    },

    video: {
      eyebrow: "Watch",
      heading: "Endoscopic Spine Surgery Explained",
    ...
    cta: {
      heading: "Take the next step — with clarity.",
      text: "Unsure whether surgery is the right path for you? A specialist-led consultation will help you understand your options — clearly, honestly and without pressure.",
    ...
    faq: [
      ...
      { q: "How long does recovery take after endoscopic spine surgery?", a: "Patients are walking 2 hours after surgery and are discharged the same day. With the availability of aqua therapy At Secure Clinics itself, rehabilitation can be started within a week." },
      ...
      { q: "Can endoscopic spine surgery cure back pain permanently?", a: "The outcome depends on the underlying cause of back pain. Surgery aims to treat the specific spinal problem causing symptoms, while long-term recovery also depends on rehabilitation, nutrition and lifestyle factors — all of which are provided At Secure Clinics." },
      { q: "Is the surgery performed at the clinic or a hospital?", a: "Spine surgery is carried out in a well equipped hospital setting. At Secure Clinics has skilled surgeons attached with the top hospitals in Mumbai like Reliance, Saifee, Breach Candy, Bhatia, SRCC Children's and Wockhardt Hospitals." },
      ...
      { q: "How soon can I walk after endoscopic spine surgery?", a: "Many patients are mobilised as fast as 2 hours after surgery and usually discharged the next day. Your surgical and physiotherapy team At Secure Clinics provides guidance for safe movement after the procedure and discharge." },
    ],
  },
  ...
  // ───────────────────────── PAGE 2 ─────────────────────────
  {
    ...
    category: "surgical",
    cardTitle: "MINIMALLY INVASIVE SURGERY",
    iconKey: "bone",
    metaTitle: "Minimally Invasive Spine Surgery in Mumbai | SecureClinics",
    metaDescription:
      "Minimally invasive spine surgery (MIS) in Mumbai — advanced techniques, smaller incisions, preserved muscles and smarter recovery.",
    ...
    experience: {
      heading: "Technique matters. Judgment matters even more.",
      intro:
        "Our spine surgeons combine modern MIS techniques with deep surgical judgment, ensuring each procedure is matched to the patient, not the trend.",
      listTitle: "This allows us to:",
      points: [
        "Select the right candidates for MIS",
        "Preserve spinal muscles and stability",
        "Reduce post-operative pain and recovery time",
        "Deliver consistent, evidence-based outcomes",
      ],
      closing: "Minimally invasive — never minimally considered.",
    },

    procedures: {
      eyebrow: "Procedures",
      heading: "Minimally Invasive Spine Procedures We Offer",
      items: [
        { number: "01", title: "MIS Fusion", description: "Stabilisation of unstable spinal segments using minimally invasive techniques to reduce muscle damage and recovery time." },
        { number: "02", title: "MIS Deformity Correction", description: "Carefully planned minimally invasive correction for selected spinal deformities — prioritising alignment, balance and safety." },
        { number: "03", title: "MIS Decompression", description: "Targeted relief of nerve compression caused by spinal stenosis or disc-related narrowing using muscle-sparing approaches." },
        { number: "04", title: "OLIF <code>/</code> KLIF <code>/</code> TLIF", description: "Advanced minimally invasive fusion techniques chosen based on anatomy, pathology and surgical goals — ensuring optimal spinal alignment and stability." },
        { number: "05", title: "Vertebroplasty", description: "Minimally invasive stabilisation of painful vertebral fractures using bone cement to restore strength and reduce pain." },
        { number: "06", title: "Kyphoplasty", description: "Balloon-assisted vertebral stabilisation to correct compression fractures, restore height and improve spinal alignment." },
      ],
    },

    benefits: {
      eyebrow: "Benefits",
      heading: "Benefits of Minimally Invasive Spine Surgery ",
      items: [
        "Smaller incisions",
        "Reduced blood loss",
        "Less muscle injury",
    ...
    rightForYou: {
      eyebrow: "Eligibility",
      heading: "Is Minimally Invasive Spine Surgery Right for You?",
      intro: "Minimally invasive spine surgery may be considered for:",
      items: [
        "Degenerative disc disease",
        "Spinal instability",
        "Nerve compression or stenosis",
        "Vertebral compression fractures",
        "Selected deformity corrections",
      ],
      closing:
        "A detailed consultation is essential to determine the most appropriate approach.",
    },

    video: {
      eyebrow: "Watch",
      heading: "Minimally Invasive Spine Surgery",
      url: "https://cdn.prod.website-files.com/604926b0c95ad5f7026a505d%2F69136cda4850c7f206613aef_Mi%20peli%CC%81cula%202-transcode.mp4",
    },

    cta: {
      heading: "Considering MIS? Let’s talk it through.",
      text: "Every spine is different — and so is every surgical plan. A specialist consultation will help you understand whether MIS is the right fit for you.",
      buttonLabel: "Book a Consultation",
      buttonHref: "/contact-us",
    },
    ...
    faq: [
      ...
      { q: "How do I know if I need minimally invasive spine surgery (MIS)?", a: "At Secure Clinics, an expert spine specialist evaluates symptoms, examination findings, and imaging results before recommending surgery." },
  ...
  // ───────────────────────── PAGE 3 ─────────────────────────
  {
    slug: "spine-surgery",
    category: "surgical",
    cardTitle: "SPINE SURGERY",
    iconKey: "stethoscope",
    metaTitle: "Spine Surgery in Mumbai | SecureClinics",
    metaDescription:
      "Comprehensive spine surgery in Mumbai — from scoliosis and deformity to cervical and tumour surgery, guided by clinical need and experience.",

    hero: {
      eyebrow: "SPINE@SECURECLINICS",
      title: "Spine Surgery in Mumbai",
      tagline: "Comprehensive Spine Care. Precise Decisions. Trusted Outcomes.",
      intro:
        "At <code>@</code>SecureClinics, spine surgery is approached with depth, discipline and responsibility. With over a decade of experience in complex spine surgery in Mumbai, our team treats a wide spectrum of spinal conditions — always guided by clinical need, not urgency.",
      closing:
    ...
    why: {
      eyebrow: "Why Spine Surgery?",
      heading: "When conservative care is no longer enough.",
      paragraphs: [
        "Spine surgery is considered when pain, deformity, instability or neurological compromise significantly affects quality of life and non-surgical treatments have been exhausted.",
        "At <code>@</code>SecureClinics, every surgical recommendation is backed by thorough evaluation, detailed discussion and a clear plan for recovery.",
      ],
    },

    experience: {
      heading: "Trusted Spine Surgeons in Mumbai",
      intro:
        "Our spine team brings together over 10 years of focused surgical experience across degenerative, traumatic, infectious and complex spinal conditions.",
      listTitle: "This experience allows us to:",
      points: [
        "Handle complex spinal pathologies safely",
        "Choose the most appropriate surgical approach",
        "Minimise complications through meticulous planning",
        "Support structured post-surgical rehabilitation",
      ],
      closing: "Expertise matters — especially in advanced spine surgery.",
    },

    procedures: {
      eyebrow: "Procedures",
      heading: "Spine Surgery Procedures We Offer",
      items: [
        { number: "01", title: "Scoliosis Surgery", description: "Correction of spinal curvature using carefully planned surgical techniques to restore balance, alignment and function." },
        { number: "02", title: "Spine Deformity Surgery", description: "Advanced surgical management of complex spinal deformities in adults and adolescents, with a focus on long-term stability." },
        { number: "03", title: "Spine Fracture Surgery", description: "Stabilisation and reconstruction of spinal fractures caused by trauma or osteoporosis to protect neurological function and enable recovery." },
        { number: "04", title: "Spine Tumour Surgery", description: "Precise surgical treatment for benign and malignant spinal tumours, prioritising neurological safety and structural stability." },
    ...
    rightForYou: {
      eyebrow: "Eligibility",
      heading: "Is Spine Surgery Right for You?",
      intro: "Spine surgery may be considered for:",
      items: [
      ...
      closing: "A detailed consultation is essential before proceeding.",
    },
    ...
    cta: {
      heading: "Considering spine surgery? Start with clarity.",
      text: "A structured consultation helps you understand what’s happening, what’s needed and what recovery will look like.",
      buttonLabel: "Book a Consultation",
      buttonHref: "/contact-us",
    },
  },
  ...
  // ───────────────────────── PAGE 4 ─────────────────────────
  {
    slug: "knee-surgery",
    category: "surgical",
    cardTitle: "KNEE SURGERY",
    iconKey: "heartPulse",
    metaTitle: "Knee Surgery in Mumbai | SecureClinics",
    metaDescription:
      "Advanced knee surgery in Mumbai — robotic replacement, ACL reconstruction, cartilage and meniscus repair with precision and confident recovery.",
    ...
    why: {
      eyebrow: "Why Knee Surgery?",
      heading: "When knee pain limits movement, stability or performance.",
      paragraphs: [
        "Knee surgery is considered when pain, instability or cartilage damage affects daily life or sports performance and conservative treatments no longer provide relief.",
        "At <code>@</code>SecureClinics, each surgical recommendation is based on detailed assessment, imaging correlation and functional goals.",
      ],
    },

    experience: {
      heading: "Experienced Knee Surgeons in Mumbai",
      intro:
        "Our orthopaedic team brings extensive experience in both joint preservation and joint replacement procedures.",
      listTitle: "This expertise allows us to:",
      points: [
        "Choose between repair, preservation or replacement",
        "Use technology-driven surgical planning",
        "Restore alignment, stability and motion",
        "Support predictable recovery outcomes",
      ],
      closing: "Precision matters — especially in knee surgery.",
    },

    procedures: {
      eyebrow: "Procedures",
      heading: "Knee Surgery Procedures We Offer",
      items: [
    ...
    benefits: {
      eyebrow: "Benefits",
      heading: "Benefits of Knee Surgery ",
      items: [
        "Advanced surgical planning",
        "Precision-driven techniques",
        "Focus on joint preservation where possible",
    ...
    rightForYou: {
      eyebrow: "Eligibility",
      heading: "Is Knee Surgery Right for You?",
      intro: "Knee surgery may be considered for:",
      items: [
        "Severe knee arthritis",
        "Sports-related ligament injuries",
        "Meniscal or cartilage damage",
        "Knee deformity or malalignment",
        "Persistent pain affecting daily activities",
      ],
      closing:
        "A specialist consultation is essential to determine the most appropriate surgical approach.",
    },

    video: {
      eyebrow: "Watch",
      heading: "Knee Surgery",
      url: "https://cdn.prod.website-files.com/604926b0c95ad5f7026a505d%2F69136cda4850c7f206613aef_Mi%20peli%CC%81cula%202-transcode.mp4",
    },

    cta: {
      heading: "Back on your feet — with a plan.",
      text: "From sports injuries to joint replacement, a specialist consultation will help you choose the right path forward.",
      buttonLabel: "Book a Consultation",
      buttonHref: "/contact-us",
    },
    ...
    faq: [
      ...
      { q: "Why choose At Secure Clinics for knee surgery in Mumbai?", a: "Secure Clinics provides specialist orthopaedic evaluation, advanced knee procedures, personalised surgical planning, rehabilitation-focused care, long-term functional recovery support, and complete care under one roof. Our approach focuses on helping patients return to an active lifestyle." },
      { q: "What is the cost of knee surgery in Mumbai?", a: "The cost depends on the type of procedure, complexity of the condition, implant or surgical requirements, and individual treatment plan. A consultation with our specialists At Secure Clinics helps determine the appropriate treatment and expected cost, presented with full transparency so you can decide with clarity." },
    ],
  },
  ...
  // ───────────────────────── PAGE 5 ─────────────────────────
  {
    ...
    category: "surgical",
    cardTitle: "SHOULDER SURGERY",
    iconKey: "waves",
    metaTitle: "Shoulder Surgery in Mumbai | SecureClinics",
    metaDescription:
      "Advanced shoulder surgery in Mumbai — arthroscopic rotator cuff repair, replacement, SLAP and Bankart repairs with precision care.",

    hero: {
      eyebrow: "ORTHO@SECURECLINICS",
      title: "Shoulder Surgery in Mumbai",
      tagline: "Advanced Surgical Treatment for Shoulder Pain, Injuries <code>&amp;</code> Joint Disorders",
      intro: [
        ...
        "At Secure Clinics, Mumbai, our best orthopaedic specialists provide comprehensive shoulder surgical care using advanced techniques, accurate diagnosis, and personalised rehabilitation programs.",
      ...
      closing: "From diagnosis and surgical planning to post-operative rehabilitation, At Secure Clinics focuses on restoring strength, mobility, and long-term shoulder function.",
      image: ShoulderSurgeryImg,
    },

    why: {
      eyebrow: "Why Shoulder Surgery?",
      heading: "When shoulder pain or instability limits movement and function.",
      paragraphs: [
        "Shoulder surgery is considered when pain, weakness or recurrent instability affects daily life or sports and conservative treatments no longer provide lasting relief.",
        "At <code>@</code>SecureClinics, surgical recommendations are based on detailed clinical evaluation, imaging findings and functional goals.",
      ],
    },

    experience: {
      heading: "Experienced Shoulder Surgeons in Mumbai",
      intro:
        "Our orthopaedic team has significant experience in both arthroscopic and joint replacement shoulder procedures.",
      listTitle: "This experience allows us to:",
      points: [
        "Address complex shoulder injuries accurately",
        "Use minimally invasive arthroscopic techniques where appropriate",
        "Restore stability, strength and range of motion",
        "Support predictable functional recovery",
      ],
      closing: "Experience and precision are critical in shoulder surgery.",
    },

    procedures: {
      eyebrow: "Procedures",
      heading: "Shoulder Surgery Procedures We Offer",
      items: [
        { number: "01", title: "Arthroscopic Rotator Cuff Repair", description: "Minimally invasive repair of torn rotator cuff tendons to restore shoulder strength and reduce pain." },
        { number: "02", title: "Shoulder Arthroscopy", description: "Keyhole surgery to diagnose and treat a range of shoulder conditions with minimal tissue disruption." },
        { number: "03", title: "Total <code>/</code> Reverse Shoulder Replacement", description: "Advanced joint replacement options for severe arthritis, rotator cuff deficiency or complex shoulder damage." },
        { number: "04", title: "SLAP Tear Repair", description: "Arthroscopic repair of labral tears commonly seen in athletes and active individuals." },
        { number: "05", title: "Bankart Repair <code>/</code> Shoulder Dislocation Surgery", description: "Surgical stabilisation of recurrent shoulder dislocations to prevent future instability." },
        { number: "06", title: "AC Joint Surgery <code>/</code> Fracture Fixation", description: "Surgical treatment of acromioclavicular joint injuries and fractures to restore alignment and function." },
        { number: "07", title: "Frozen Shoulder Surgery", description: "Targeted surgical intervention for resistant frozen shoulder cases unresponsive to conservative treatment." },
      ],
    },

    benefits: {
      eyebrow: "Benefits",
      heading: "Benefits of Shoulder Surgery ",
      items: [
        ...
        "Long-term joint function focus",
      ],
    },

    rightForYou: {
      eyebrow: "Eligibility",
      heading: "Is Shoulder Surgery Right for You?",
      intro: "Shoulder surgery may be considered for:",
      items: [
        "Persistent shoulder pain or weakness",
        "Rotator cuff tears",
        "Recurrent shoulder dislocations",
        "Shoulder arthritis or joint damage",
        "Sports-related shoulder injuries",
      ],
      closing:
        "A specialist consultation is essential to determine the most appropriate surgical approach.",
    ...
    cta: {
      heading: "Restore your range — with confidence.",
      text: "Whether it’s a sports injury or long-standing shoulder pain, a specialist consultation will clarify your next step.",
      buttonLabel: "Book a Consultation",
      buttonHref: "/contact-us",
    },
  ...
  // ───────────────────────── PAGE 6 ─────────────────────────
  {
    ...
    hero: {
      eyebrow: "ORTHO@SECURECLINICS",
      title: "Foot <code>&</code> Ankle Surgery in Mumbai",
      tagline: "Advanced Surgical Care for Foot Pain, Ankle Injuries <code>&</code> Mobility Restoration",
      intro: [
        ...
        "At Secure Clinics, Mumbai, our orthopaedic specialists provide comprehensive foot and ankle surgical care using advanced techniques, accurate diagnosis, and rehabilitation-focused treatment plans.",
      ...
      introItems: [
        ...
        "Sports<code>-</code>related foot and ankle injuries",
        "Foot deformities",
      ...
      closing: "From diagnosis and surgical planning to rehabilitation and recovery, the most skilled and qualified team of doctors At Secure Clinics focus on restoring comfortable movement and improving quality of life.",
      image: FootAnkleImg,
    },
    ...
    why: {
      ...
      paragraphs: [
        ...
        "At <code>@</code>SecureClinics, surgical decisions are based on careful evaluation, imaging correlation and functional goals.",
      ],
    },
    ...
    experience: {
      ...
      listTitle: "This expertise allows us to:",
      points: [
        "Restore proper alignment and biomechanics",
        "Address complex fractures and deformities",
        "Use minimally invasive and arthroscopic techniques where appropriate",
        "Improve long-term walking comfort and stability",
      ],
      closing:
        "Precision and planning are essential in foot and ankle surgery.",
    },
    ...
    procedures: {
      ...
      items: [
        ...
        { number: "05", title: "Ankle Fusion", description: "Surgical fusion for severe ankle arthritis to relieve pain and restore stability." },
        { number: "06", title: "Ankle Replacement", description: "Joint replacement surgery for advanced ankle arthritis, preserving motion and improving gait in selected patients." },
        { number: "07", title: "Hammertoe <code>/</code> Toe Deformity Surgery", description: "Correction of toe deformities to improve alignment, comfort and footwear tolerance." },
      ],
    },

    benefits: {
      eyebrow: "Benefits",
      heading: "Benefits of Foot and Ankle Surgery ",
      items: [
        "Precise alignment restoration",
        "Advanced fixation and surgical techniques",
        "Improved walking stability and balance",
    ...
    rightForYou: {
      ...
      items: [
        ...
        "Tendon injuries affecting mobility",
      ],
      closing:
        "A specialist consultation is essential to determine the most appropriate surgical approach.",
    },
    ...
    cta: {
      heading: "Walk with confidence again.",
      text: "From stubborn pain to chronic instability, a specialist consultation helps you choose the right surgical path.",
      buttonLabel: "Book a Consultation",
      buttonHref: "/contact-us",
    },
    ...
    faq: [
      ...
      { q: "Why choose At Secure Clinics for foot and ankle surgery in Mumbai?", a: "Secure Clinics provides specialist orthopaedic assessment, advanced surgical techniques, personalised treatment planning, rehabilitation-focused recovery, and a complete patient care pathway. The goal is to restore comfortable movement and long-term function." },
      { q: "What is the cost of foot and ankle surgery in Mumbai?", a: "The cost depends on the type of procedure, complexity of condition, surgical requirements, hospital requirements, and rehabilitation needs. A consultation helps determine the right treatment plan. At Secure Clinics team will guide you every step of the way with clarity and keeping your comfort in mind." },
    ],
  },

  // ───────────────────────── PAGE 7 ─────────────────────────
  {
    slug: "hand-and-upper-limb-surgery",
    category: "surgical",
    ...
    hero: {
      eyebrow: "ORTHO@SECURECLINICS",
      title: "Hand <code>&amp;</code> Upper Limb Surgery in Mumbai",
      tagline: "Advanced Surgical Care for Hand, Wrist, Elbow <code>&amp;</code> Upper Limb Conditions",
      intro: [
        ...
        "At Secure Clinics, Mumbai, our orthopaedic specialists provide comprehensive hand and upper limb surgical care using advanced techniques, accurate diagnosis, and personalised rehabilitation plans.",
      ...
      closing: "From diagnosis and surgical planning to rehabilitation and recovery, At Secure Clinics focuses on restoring strength, mobility, and confidence in daily activities.",
      image: HandBoneImg,
    },
    ...
    why: {
      ...
      paragraphs: [
        ...
        "At <code>@</code>SecureClinics, surgical decisions are based on careful evaluation and functional impact.",
      ],
    },
    ...
    experience: {
      ...
      listTitle: "This experience allows us to:",
      points: [
        "Restore nerve and tendon function",
        "Treat complex fractures and injuries",
        "Use precision microsurgical techniques",
        "Improve grip strength and hand coordination",
      ],
      closing: "Accuracy is critical in hand surgery.",
    },
    ...
    procedures: {
      ...
      items: [
        ...
        { number: "03", title: "Trigger Finger Release", description: "Simple surgical procedure to relieve painful locking and clicking of fingers." },
        { number: "04", title: "Microsurgery", description: "Advanced surgical techniques for nerve, tendon and vessel repair under magnification." },
        { number: "05", title: "Ganglion Cyst Removal", description: "Surgical excision of painful or recurrent ganglion cysts affecting the wrist or hand." },
      ],
    },

    benefits: {
      eyebrow: "Benefits",
      heading: "Benefits of Hand and Upper Limb Surgery ",
      items: [
        "Precision-focused surgical techniques",
        "Improved hand function and strength",
        "Relief from pain and nerve symptoms",
        "Faster return to daily use",
    ...
    rightForYou: {
      ...
      items: [
        ...
        "Tendon locking or stiffness",
        "Hand or wrist fractures",
        "Nerve or tendon injuries",
        "Painful masses or cysts",
      ],
      closing:
        "A specialist consultation is essential to determine the most appropriate treatment.",
    },
    ...
    cta: {
      heading: "Restore precision — hand in hand.",
      text: "Small problems in the hand have big effects on daily life. A specialist consultation will guide your recovery.",
      buttonLabel: "Book a Consultation",
      buttonHref: "/contact-us",
    },
    ...
    faq: [
      ...
      { q: "Why choose At Secure Clinics for hand and upper limb surgery in Mumbai?", a: "At Secure Clinics provides specialist orthopaedic evaluation, advanced surgical techniques, personalised treatment planning, and rehabilitation-focused care — all under one roof with a complete team of specialists in every field." },
      { q: "What is the cost of hand or upper limb surgery in Mumbai?", a: "The cost depends on the type of procedure, complexity of condition, surgical requirements, hospital requirements, and rehabilitation needs. The team At Secure Clinics will take into account all your needs and guide you forward keeping your comfort and care in mind." },
    ],
  },
  ...
  // ───────────────────────── PAGE 8 ─────────────────────────
  {
    slug: "hip-surgery",
    category: "surgical",
    cardTitle: "HIP SURGERY",
    iconKey: "microscope",
    metaTitle: "Hip Surgery in Mumbai | SecureClinics",
    metaDescription:
      "Advanced hip surgery in Mumbai — total, partial and revision hip replacement, arthroscopy and resurfacing for confident mobility.",

    hero: {
      eyebrow: "ORTHO@SECURECLINICS",
      title: "Hip Surgery At Secure Clinics Mumbai",
      tagline: "Advanced Surgical Care for Hip Pain, Joint Damage <code>&amp;</code> Mobility Restoration",
      intro: [
        ...
        "At Secure Clinics, Mumbai, the best team of orthopaedic specialists and physiotherapists provide comprehensive hip surgical care using advanced techniques, evidence-based treatment planning, and personalised rehabilitation programs.",
      ...
      closing: "From diagnosis and surgical planning to rehabilitation and recovery, At Secure Clinics focuses on restoring movement, reducing pain, and helping patients return to an active lifestyle.",
      image: HipSurgeryImg,
    },

    why: {
      eyebrow: "Why Hip Surgery?",
      heading: "When hip pain limits walking, sitting or daily activities.",
      paragraphs: [
        "Hip surgery is considered when arthritis, fractures, labral injuries or joint damage affect quality of life and conservative treatments no longer provide relief.",
        "At <code>@</code>SecureClinics, surgical recommendations are guided by detailed clinical evaluation, imaging and functional goals.",
      ],
    },

    experience: {
      heading: "Experienced Hip Surgeons in Mumbai",
      intro:
        "Our orthopaedic team has strong expertise in joint replacement, joint preservation and revision hip surgery.",
      listTitle: "This experience allows us to:",
      points: [
        "Choose between repair, resurfacing or replacement",
        "Use advanced surgical planning techniques",
        "Restore hip biomechanics and alignment",
        "Support predictable recovery outcomes",
      ],
      closing: "Precision and experience are essential in hip surgery.",
    },

    procedures: {
      eyebrow: "Procedures",
      heading: "Hip Surgery Procedures We Offer",
      items: [
    ...
    benefits: {
      eyebrow: "Benefits",
      heading: "Benefits of Hip Surgery ",
      items: [
    ...
    rightForYou: {
      eyebrow: "Eligibility",
      heading: "Is Hip Surgery Right for You?",
      intro: "Hip surgery may be considered for:",
      items: [
    ...
    cta: {
      heading: "Move without limits — with the right plan.",
      text: "From arthritis to labral injuries, a specialist consultation helps you find the right surgical path.",
      buttonLabel: "Book a Consultation",
      buttonHref: "/contact-us",
    },
    ...
    faq: [
      ...
      { q: "Why choose At Secure Clinics for hip surgery in Mumbai?", a: "Secure Clinics provides specialist orthopaedic evaluation, advanced hip procedures, personalised surgical planning, rehabilitation-focused recovery, and long-term mobility support. Our goal is to help patients regain movement, independence, and quality of life." },
      { q: "What is the cost of hip surgery in Mumbai?", a: "The cost depends on the type of surgery, complexity of condition, implant or procedure requirements, hospital requirements, and rehabilitation needs. The team At Secure Clinics is dedicated to guide you depending on your comfort and needs." },
    ],
  },
  ...
  // ─── NS PAGE 1 ─── Injections and IV Therapy
  {
    ...
    hero: {
      ...
      title: "Injections and IV Therapy for Pain Relief, Recovery and Better Health  in Mumbai",
      tagline: "Targeted Relief. Precision Delivery. No Guesswork.",
      intro: [
        "At Secure Clinics, our advanced Injections and IV therapy treatments provide personalised non-surgical solutions for pain management, tissue healing, recovery and overall musculoskeletal wellness.",
    ...
    why: {
      eyebrow: "Why Injections and IV Therapy At Secure Clinics?",
      ...
      paragraphs: [
        ...
        "At Secure Clinics, every treatment plan is designed after understanding:",
      ],
      items: [
        "Your diagnosis",
    ...
    experience: {
      ...
      points: [
        ...
        "Avoid unnecessary repeat injections",
        "Combine injections with physiotherapy and rehab",
        "Improve outcomes while reducing medication dependence",
      ],
      closing: "Precision matters — especially when treating pain.",
    },
    ...
    procedures: {
      ...
      items: [
        ...
        { number: "03", title: "Facet Joint Block", description: "Injection into small spinal joints responsible for chronic back or neck pain." },
      ...
      extraGroups: [
        {
          heading: "Advanced IV Therapies",
          items: [
            { number: "01", title: "IV Ozone Therapy", description: "Supports oxygen delivery, reduces inflammation and promotes healing at a cellular level." },
            { number: "02", title: "EBOO Therapy", description: "Advanced blood oxygenation and purification therapy used for systemic inflammation and recovery support." },
            { number: "03", title: "IV Longevity Therapy", description: "Personalised IV formulations aimed at cellular repair, energy support and metabolic balance." },
          ],
        },
      ],
    },
    ...
    benefits: {
      eyebrow: "Benefits",
      heading: "Benefits of Injections and IV Therapy ",
      items: [
        "Image-guided precision delivery",
        "Reduced reliance on oral medications",
        "Faster pain relief and mobility",
        "Day-care procedures",
        "Combined with rehab for long-term results",
        "Personalised — never protocol-driven",
      ],
    },

    rightForYou: {
      eyebrow: "Eligibility",
      heading: "Is Injection or IV Therapy Right for You?",
      intro: "These treatments may be considered if you have:",
      items: [
        "Persistent spine or joint pain",
        "Nerve-related pain (sciatica, cervical radiculopathy)",
        "Inflammatory joint conditions",
        "Muscle trigger point pain",
        "Chronic fatigue or recovery needs",
      ],
      closing: "A detailed consultation is essential before proceeding.",
    },

    cta: {
      heading: "Targeted relief, starting with the right diagnosis.",
      text: "A specialist-led consultation helps identify the true pain source — so treatment is precise, not trial-and-error.",
      buttonLabel: "Book a Consultation",
      buttonHref: "/contact-us",
    },
  ...
  // ─── NS PAGE 2 ─── Path Labs and Imaging
  {
    ...
    hero: {
      eyebrow: "LABS@SECURECLINICS",
      title: "Path Labs and Imaging Services for Accurate Diagnosis  in Mumbai",
      tagline: "Clear Answers. Reliable Results. One Place.",
      intro: [
        ", our advanced in-house pathology and imaging services support accurate diagnosis and personalised treatment planning for bone, joint, spine and musculoskeletal conditions.",
        "A correct diagnosis is the foundation of effective treatment. Our diagnostic approach combines advanced imaging technology, clinical expertise and detailed evaluation to identify the underlying cause of pain, injury or movement limitations. , diagnostics are done with purpose. Every test is ordered to answer a specific clinical question, not as a routine checklist.",
    ...
    why: {
      eyebrow: "Why Diagnostic Care At Secure Clinics?",
      ...
      paragraphs: [
        ...
        ", every diagnostic evaluation is planned after understanding:",
      ],
      items: [
        "Your symptoms",
        "Medical history",
    ...
    experience: {
      heading: "Advanced Diagnostic Facilities in Mumbai",
      intro:
        "Secure Clinics offers in-house diagnostic services, allowing doctors to work faster and more accurately.",
      listTitle: "This allows us to:",
      points: [
        "Correlate symptoms with test results",
        "Adjust treatment in real time",
        "Reduce repeat visits across multiple centres",
        "Maintain continuity of care",
      ],
      closing: "Accuracy, clarity and coordination are central to our approach.",
    },
    ...
    procedures: {
      ...
      items: [
        ...
        { number: "06", title: "Ultrasound", description: "Real-time imaging for soft tissue, joint and guided procedures." },
      ],
    },
    ...
    cta: {
      heading: "Diagnostics designed to guide treatment.",
      text: "Schedule a consultation — we’ll align the right investigations with your clinical picture.",
      buttonLabel: "Book a Consultation",
      buttonHref: "/contact-us",
    },
    ...
    faq: [
      ...
      { q: "Are imaging tests safe?", a: ", our X-Ray Machine has longer plates hence reducing the radiation exposure and the requirement of the number of imaging shots are cut down to half." },
  ...
  // ─── NS PAGE 3 ─── Aqua Therapy
  {
    ...
    iconKey: "waves",
    metaTitle: "Aqua Therapy in Mumbai | SecureClinics",
    metaDescription:
      "Clinical aquatic rehabilitation in Mumbai — Bad Ragaz, Ai Chi, Watsu, Halliwick and aquatic strength training guided by trained therapists.",

    hero: {
      eyebrow: "AQUA@SECURECLINICS",
      title: "Aquatherapy for Pain Relief, Rehabilitation and Improved Mobility  in Mumbai",
      tagline: "Movement Supported. Recovery Reimagined.",
      intro: [
        "At Secure Clinics, our aquatherapy and aquatic rehabilitation programs provide a gentle yet effective approach to managing pain, improving mobility and supporting recovery from orthopaedic conditions and post surgery.",
    ...
    why: {
      eyebrow: "Why Aquatherapy At Secure Clinics?",
      ...
      paragraphs: [
        ...
        "At Secure Clinics, every aquatherapy plan is designed after understanding:",
      ],
      items: [
        "Your diagnosis",
    ...
    experience: {
      heading: "Experienced Aqua Therapists in Mumbai",
      intro:
        "Our aqua therapists are trained in specialised aquatic rehabilitation methods, not general pool exercises.",
      listTitle: "This allows us to:",
      points: [
        "Use water strategically for recovery",
        "Adapt intensity to pain and confidence levels",
        "Improve balance, strength and coordination",
        "Transition patients safely to land therapy",
      ],
      closing: "Aqua therapy is clinical, progressive and purposeful.",
    },
    ...
    benefits: {
      eyebrow: "Benefits",
      heading: "Benefits of Aquatherapy ",
      items: [
    ...
    cta: {
      heading: "Move more — with the support of water.",
      text: "A clinical assessment helps us design the right aquatic plan for your condition and recovery stage.",
      buttonLabel: "Book a Consultation",
      buttonHref: "/contact-us",
    },
    ...
    faq: [
      ...
      { q: "How clean is the pool?", a: "The pool at At Secure Clinics is a medical-grade pool maintained to clinical hygiene standards. Water is continuously filtered and chemically treated." },
      { q: "Is there a lady doctor available?", a: "Yes. Female doctors and therapists are part of the At Secure Clinics team. If you'd like to be seen by a female specialist, let us know when booking and we'll arrange accordingly." },
  ...
  // ─── NS PAGE 4 ─── Physiotherapy
  {
    ...
    iconKey: "activity",
    metaTitle: "Physiotherapy in Mumbai | SecureClinics",
    metaDescription:
      "Clinical physiotherapy in Mumbai — manual therapy, exercise, electrotherapy, laser and bracing, built around your diagnosis and goals.",

    hero: {
      eyebrow: "FLEX@SECURECLINICS",
      title: "Physiotherapy for Pain Relief, Recovery and Improved Mobility  in Mumbai",
      tagline: "Thoughtful Rehab. Precise Movement. Real Progress.",
      intro: [
        "At Secure Clinics, Mumbai, our physiotherapy services focus on reducing pain, restoring movement and improving physical function through personalised rehabilitation programs.",
    ...
    why: {
      eyebrow: "Why Physiotherapy At Secure Clinics?",
      ...
      paragraphs: [
        ...
        "At Secure Clinics, every physiotherapy program is designed after understanding:",
      ],
      items: [
        "Your diagnosis",
      ...
      closing:
        "Our goal is to help patients return to active and independent living. , physiotherapy is closely aligned with medical, interventional and surgical care for continuity and better outcomes. Our multidisciplinary approach of having spine and orthopaedic surgeons and physiotherapists working together helps patients achieve safer and more effective recovery, as rehabilitation is part of the treatment and not just optional after-care. With well-equipped, technologically advanced machines, a training gym, an aquatherapy set-up and skilled physiotherapists and trainers, fragmented care in your recovery ends here.",
    },

    experience: {
      heading: "Experienced Physiotherapists in Mumbai",
      intro:
        "Our physiotherapists are trained in advanced movement assessment, manual techniques and rehabilitation science.",
      listTitle: "This allows us to:",
      points: [
        "Identify movement dysfunctions accurately",
        "Adjust treatment based on progress",
        "Progress rehabilitation safely",
        "Coordinate care when needed",
      ],
      closing:
        "Effective physiotherapy is precise, progressive and patient-specific.",
    },
    ...
    cta: {
      heading: "Guided rehab. Real progress.",
      text: "Book a structured assessment — and get a physiotherapy plan built around how you actually move.",
      buttonLabel: "Book a Consultation",
      buttonHref: "/contact-us",
    },
    ...
    faq: [
      ...
      { q: "How long does physiotherapy treatment take?", a: "Recovery time depends on the condition, severity, consistency of treatment and individual response. At Secure Clinics, a team of surgeons and doctors together make a personalised plan with you keeping in mind your recovery goal." },
      ...
      { q: "How many physiotherapy sessions are required?", a: "The number of sessions depends on the diagnosis, recovery goals and progress. At Secure Clinics, our specialists will guide you based on your needs." },
      ...
      { q: "Is the clinic wheelchair or crutches friendly?", a: "Yes, completely. At Secure Clinics has step-free entry, wide corridors, and a chair lift for pool access." },
      { q: "What's the difference between physiotherapy, orthopaedics, and spine care — how do I know which one is right for me?", a: "Orthopaedics focuses on bones, joints, and surgical conditions. Spine care is specialised treatment for the neck, back, and spinal cord. Physiotherapy uses movement, manual therapy, and exercise to restore function and reduce pain. In many cases, all three work together on the same patient. At At Secure Clinics, you don't need to figure this out yourself — tell us your symptoms and we'll guide you to the right specialist, or to multiple specialists if needed, but in one place." },
      { q: "Do you have in-house diagnostics, or will I need to go elsewhere for scans and tests?", a: "All pathology and diagnostics solutions are found within our space. There is no need for you to go to multiple places to get tests done and then come back to us. Your entire journey is integrated into one ecosystem, here at At Secure Clinics." },
      { q: "Are trainers or physios present during gym sessions?", a: "Always. You are never left alone with equipment. Every session at At Secure Clinics is supervised by a physiotherapist who monitors your form, progression, and safety throughout." },
      { q: "Is there a gym at the facility?", a: "Yes. At Secure Clinics has a fully equipped rehabilitation and strength training space on-site. It's used for post-surgical recovery, injury rehab, strength training, and performance conditioning — supervised by qualified professionals at all times." },
      { q: "Is there a lady doctor available?", a: "Yes. Female doctors and therapists are part of the At Secure Clinics team. If you'd like to be seen by a female specialist, let us know when booking and we'll arrange accordingly." },
      { q: "Do you do home visits?", a: "Yes. For patients who are in pain or discomfort and cannot travel to our clinic, we offer the facility of home visits. Call or WhatsApp us for more details on this." },
    ],
  },
  ...
  // ─── NS PAGE 5 ─── Strength Training
  {
    ...
    iconKey: "dumbbell",
    metaTitle: "Strength Training in Mumbai | SecureClinics",
    metaDescription:
      "Clinical strength training in Mumbai — isometric, isotonic, resistance and kinetic chain work for stability, recovery and injury prevention.",
    ...
    hero: {
      ...
      intro: [
        "At Secure Clinics, Mumbai, our clinical strength training programs are designed to improve muscle strength, joint stability, mobility and overall physical function through personalised exercise-based rehabilitation.",
    ...
    why: {
      eyebrow: "Why Strength Training At Secure Clinics?",
      heading: "The stronger your muscles, the safer your joints.",
      paragraphs: [
        ", every strength training program is planned after understanding:",
      ],
      items: [
        "Your diagnosis",
      ...
      closing: "At Secure Clinics, strength training is integrated with physiotherapy and medical care for safe, progressive results.",
    },
    ...
    experience: {
      ...
      listTitle: "This allows us to:",
      points: [
        "Select the right exercises for each condition",
        "Progress load safely",
        "Correct movement patterns",
        "Prevent overloading and re-injury",
      ],
      closing:
        "Effective strength training is controlled, measured and purposeful.",
    },

    procedures: {
      eyebrow: "Techniques",
      heading: "Strength Training Techniques We Offer",
      items: [
    ...
    rightForYou: {
      eyebrow: "Eligibility",
      heading: "Is Strength Training Right for You?",
      intro: "Strength training may benefit you if you have:",
      items: [
        "Joint instability or weakness",
        "Post-injury or post-surgical recovery needs",
        "Chronic pain related to poor muscle support",
        "Balance or coordination issues",
        "Goals to return to activity safely",
      ],
      closing: "A clinical assessment ensures the right starting point.",
    },

    cta: {
      heading: "Strength that supports your life.",
      text: "Start with a clinical assessment — and a strength plan that progresses with you, not against you.",
      buttonLabel: "Book a Consultation",
      buttonHref: "/contact-us",
    },

    faq: [
      { q: "What is clinical strength training?", a: "Clinical strength training is a personalised exercise program designed to improve strength, mobility and function based on a person's health condition. At Secure Clinics provides personalised strength training programs for patients with joint, spine, bone and mobility-related concerns. Our experts combine rehabilitation science, exercise therapy and orthopaedic care to help patients improve strength safely and achieve better movement outcomes." },
      ...
      { q: "Are trainers or physios present during gym sessions?", a: "Always. You are never left alone with equipment. Every session at At Secure Clinics is supervised by a physiotherapist who monitors your form, progression, and safety throughout." },
      { q: "Is there a gym at the facility?", a: "Yes. At Secure Clinics has a fully equipped rehabilitation and strength training space on-site. It's used for post-surgical recovery, injury rehab, strength training, and performance conditioning — supervised by qualified professionals at all times." },
      { q: "Is there a lady trainer available?", a: "Yes. Female trainers and therapists are part of the At Secure Clinics team. If you'd like to be seen by a female specialist, let us know when booking and we'll arrange accordingly." },
      { q: "Do you do home visits?", a: "Yes. For patients who are in pain or discomfort and cannot travel to our clinic, we offer the facility of home visits. Call or WhatsApp us for more details on this." },
    ],
  },
  ...
  // ─── NS PAGE 6 ─── Pilates
  {
    ...
    cardTitle: "PILATES",
    iconKey: "sparkles",
    metaTitle: "Pilates in Mumbai | SecureClinics",
    metaDescription:
      "Clinical Pilates in Mumbai — therapist-guided alignment, control and core stability for rehabilitation and sustainable recovery.",

    hero: {
      eyebrow: "POWER@SECURECLINICS",
      title: "Clinical Pilates for Better Posture, Mobility and Recovery  in Mumbai",
      tagline: "Controlled Movement. Better Alignment. Sustainable Recovery.",
      intro: [
        "At Secure Clinics, our clinical Pilates programs combine controlled movement, core strengthening and rehabilitation principles to improve posture, flexibility and overall physical function.",
    ...
    why: {
      eyebrow: "Why Pilates At Secure Clinics?",
      ...
      paragraphs: [
        ...
        ", every Pilates program is designed after understanding:",
      ],
      items: [
        "Your diagnosis",
      ...
      closing: "At Secure Clinics, Pilates is integrated with physiotherapy and medical care when required.",
    },

    experience: {
      heading: "Experienced Pilates Therapists in Mumbai",
      intro:
        "Our Pilates therapists are trained in clinical rehabilitation and movement correction.",
      listTitle: "This allows us to:",
      points: [
        "Modify exercises based on pain or limitation",
        "Focus on alignment and control",
        "Progress safely through recovery stages",
        "Support long-term movement efficiency",
      ],
      closing: "Precision and control are central to effective Pilates.",
    },

    procedures: {
      eyebrow: "Programs",
      heading: "Pilates Programs We Offer",
      items: [
    ...
    benefits: {
      eyebrow: "Benefits",
      heading: "Benefits of Pilates ",
      items: [
        "Improved posture and alignment",
        "Enhanced core stability",
        "Reduced pain and stiffness",
        "Safer return to movement",
    ...
    rightForYou: {
      eyebrow: "Eligibility",
      heading: "Is Pilates Right for You?",
      intro: "Pilates may be suitable if you have:",
      items: [
        "Chronic back or neck pain",
        "Postural imbalances",
        "Joint-related pain",
        "Post-surgical recovery needs",
        "Desire for controlled, guided movement",
      ],
      closing:
        "A proper assessment ensures Pilates is adapted to your needs.",
    },

    cta: {
      heading: "Move with control. Recover with intent.",
      text: "Book a clinical assessment — we’ll tailor Pilates to your alignment, pain pattern and recovery goals.",
      buttonLabel: "Book a Consultation",
      buttonHref: "/contact-us",
    },
    ...
    faq: [
      ...
      { q: "How many Pilates sessions are required?", a: "The number of sessions depends on the diagnosis, recovery goals and progress. At Secure Clinics, our specialists will guide you based on your needs." },
      { q: "Is there a lady trainer available?", a: "Yes. Female trainers and therapists are part of the At Secure Clinics team. If you’d like to be seen by a female specialist, let us know when booking and we’ll arrange accordingly." },
    ],
  },
  ...
  // ─── NS PAGE 7 ─── Clinical Nutrition
  {
    ...
    category: "nonsurgical",
    cardTitle: "CLINICAL NUTRITION",
    iconKey: "apple",
    metaTitle: "Clinical Nutrition in Mumbai | SecureClinics",
    metaDescription:
      "Clinically guided nutrition in Mumbai — supporting bone health, muscle repair, recovery and long-term mobility, never generic advice.",

    hero: {
      eyebrow: "FUEL@SECURECLINICS",
      title: "Clinical Nutrition for Bone Health, Healing and Recovery  in Mumbai",
      tagline: "Fuel Healing. Strengthen Bones. Support Recovery.",
      intro: [
        "At Secure Clinics, Mumbai, our clinical nutrition programs support bone health, muscle strength, recovery and overall musculoskeletal wellness through personalised nutrition guidance.",
    ...
    why: {
      eyebrow: "Why Clinical Nutrition At Secure Clinics?",
      ...
      paragraphs: [
        ...
        "At Secure Clinics, every nutrition plan is designed after understanding:",
      ],
      items: [
    ...
    experience: {
      heading: "Experienced Clinical Nutrition Team in Mumbai",
      intro:
        "Our nutrition experts work closely with doctors and therapists.",
      listTitle: "This allows us to:",
      points: [
      ...
      closing:
        "Nutrition plans are customised, monitored and adjusted over time.",
    },
    ...
    benefits: {
      eyebrow: "Benefits",
      heading: "Benefits of Clinical Nutrition ",
      items: [
    ...
    cta: {
      heading: "Nutrition that supports treatment.",
      text: "Book a consultation — we’ll align your nutrition plan with your diagnosis, investigations and recovery goals.",
      buttonLabel: "Book a Consultation",
      buttonHref: "/contact-us",
    },
    ...
    faq: [
      ...
      { q: "Do you offer nutrition and diet counselling as part of treatment?", a: "Yes. At Secure Clinics has an in-house nutrition team. Nutrition is integrated into treatment plans where relevant. Our nutrition programs begin from 3 months until 1 year." },
    ],
  },
  ...
  // ─── NS PAGE 8 ─── Osteoporosis and Orthopaedic Care
  {
    ...
    hero: {
      eyebrow: "ORTHO@SECURECLINICS",
      title: "Osteoporosis and Orthopaedic Bone Care for Stronger Bones  in Mumbai",
      tagline: "Stronger Bones. Smarter Orthopaedics. Better Outcomes.",
      intro: [
        "At Secure Clinics, our osteoporosis and orthopaedic bone care team focuses on improving bone health, preventing fractures and managing conditions related to bone weakness. We also carry out surgical solutions — only when necessary at the top hospitals in Mumbai.",
    ...
    why: {
      eyebrow: "Why Orthopaedic Care At Secure Clinics?",
      ...
      paragraphs: [
        ...
        "At Secure Clinics, every bone health plan is designed after understanding:",
      ],
      items: [
        "Bone density status",
        "Medical history",
      ...
      closing: "Our goal At Secure Clinics is to protect your bone health and help you stay active.",
    },
    ...
    experience: {
      ...
      closing:
        "This allows treatment plans to be predictive, preventive and precise.",
    },
    ...
    procedures: {
      ...
      items: [
        ...
        { number: "03", title: "Fracture Risk Evaluation", description: "Clinical scoring and imaging correlation to predict and prevent future fractures." },
        { number: "04", title: "Long term Monitoring", description: "Structured follow-up with periodic review to ensure treatment effectiveness." },
      ],
      extraGroups: [
        {
          heading: "Medical Treatments Offered",
          items: [
            { title: "Bisphosphonates" },
            { title: "Denosumab <code>(</code>Prolia<code>)</code>" },
            { title: "Anabolic Bone Forming Agents" },
            { title: "Hormone Related Therapies" },
            { title: "Structured Supplementation Protocols" },
          ],
        },
        {
          heading: "Orthopaedic Care Built on Bone Health",
          items: [
            { title: "Fragility Fractures", description: "Careful management of fractures occurring after minor trauma in weaker bones." },
            ...
            { title: "Surgical and Non<code>-</code>Surgical Orthopaedic Problems", description: "Balanced decisions between conservative care and surgical intervention." },
          ],
        },
        {
    ...
    rightForYou: {
      ...
      items: [
        ...
        "Have suffered a fracture after minor trauma",
        "Are planning orthopaedic or spine surgery",
        "Have chronic joint or back pain",
        "Are post-menopausal or on long-term steroids",
      ],
      closing: "A structured evaluation helps guide the right treatment.",
    },

    cta: {
      heading: "Protect your bones. Plan your orthopaedics.",
      text: "A bone-aware assessment helps prevent fractures — and makes every orthopaedic decision stronger.",
      buttonLabel: "Book a Consultation",
      buttonHref: "/contact-us",
    },
    ...
    faq: [
      ...
      { q: "When should I get a bone density test?", a: "A bone density test such as a DEXA scan may be recommended if you have risk factors for bone loss, previous fractures, reduced bone strength or concerns about osteoporosis. At Secure Clinics we have a DEXA Scan in-house for all our patients." },
      ...
      { q: "What conditions are treated under orthopaedic care?", a: "Orthopaedic care focuses on diagnosing and treating conditions affecting the bones, joints, muscles, ligaments, tendons, and spine. At Secure Clinics, our orthopaedic specialists manage conditions such as osteoarthritis, sports injuries, fractures, back pain, neck pain, frozen shoulder, ligament tears, hip pain, knee pain, foot and ankle disorders, and other musculoskeletal conditions using both non-surgical and surgical treatment options." },
